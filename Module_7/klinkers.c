...
int vowel_counter(string woord)
{
    ...
    {
        if (woord[letter] == 'a' || woord[letter] == 'e' || woord[letter] == 'u' || woord[letter] == 'i' || woord[letter] == 'o' || woord[letter == 'y' || woord[letter] == 'A' || woord[letter] == 'E' || woord[letter] == 'U' || woord[letter] == 'I' || woord[letter] == 'O')
        {
            vowel_counter++;
        }
