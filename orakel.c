...
{ 
    ...
    if (strcmp(universal_answer, "42") == true || strcmp(universal_answer, "tweeenenveertig") == true ||  strcmp(universal_answer, "forty two") == true || strcmp(universal_answer, "forty-two")  
    { 
